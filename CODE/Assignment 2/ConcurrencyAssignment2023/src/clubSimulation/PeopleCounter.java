...
public class PeopleCounter {
	...
	synchronized public void personArrivedAndWaiting(){//Counter to track the people who have arrived at the club but are waiting for a space to enter
		peopleOutSide.getAndIncrement();
	}
	synchronized public void personArrivedAndWaitingLeft(){//Counter to track the people who have arrived at the club but are waiting for a space to enter
		peopleOutSide.getAndDecrement();
	}

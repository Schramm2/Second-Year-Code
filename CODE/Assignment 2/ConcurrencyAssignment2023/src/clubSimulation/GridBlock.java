...
public class GridBlock {
	...
	public synchronized boolean get(int threadID) throws InterruptedException { //Synchronized to avoid the access of this method by two threads at the same time
